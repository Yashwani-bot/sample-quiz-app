...
function getNewQuestion(){
    ...
    // get the position of 'questionIndex' from the availabeQuestion Array;
...
function updateAnswerIndicaotr(markType){
...
function quizResult(){
    ...
    const wrong = attempt - correctAnswers;
...
function goToHome(){
    ...
    resultBox.classList.add("hide");
    // show main Box
    maintBox.classList.remove("hide")
